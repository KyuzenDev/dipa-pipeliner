      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 lg:gap-12">
        {founders.map((founder, index) => (
          <div
            ...
            className="w-full px-6 md:px-10 bg-gradient-to-r from-white to-[#B7E2FA25] border border-gray-300 rounded-xl 
          ...
          >
            ...
            <div className="flex flex-col gap-6 text-center md:text-left">
              <div className="flex flex-col gap-3">
                <p className="font-semibold text-2xl text-grayscale-900">
                  {founder.name}
                </p>
                <p className="font-normal text-md text-grayscale-600">
                  {founder.title}
                </p>
              </div>
