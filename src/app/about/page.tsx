    ...
    return (
        <>
            ...
            <div className="max-w-full w-full h-auto pt-12 gap-2">
                <div className="relative w-full gap-4 justify-between items-center flex flex-col mx-auto pb-52">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[750px]">
                            <Image
                                src="/ornament.svg"
                                alt="Ornament Image"
                                width={750}
                    ...
                    <div className="absolute w-[610px] -z-5 h-64 bg-[linear-gradient(to_top_right,_#D9F8C0,_#88CCF8)] bottom-0 right-0 rounded-xl blur-[160px]"></div>
                </div>
                <div className="w-full h-auto flex justify-center items-center py-8 px-8">
                ...
                <div className="w-full px-4 md:px-[64px] py-28 h-auto gap-16 flex flex-col items-between mx-auto">
                    ...
                    <div className="w-full bg-[#F5F8FC] flex justify-center items-center border border-grayscale-200 py-10 px-5">
                        <div className="w-full max-w-7xl flex flex-col lg:flex-row justify-center items-center gap-10 relative">
                            ...
                            <div className="flex flex-col h-full justify-center items-start text-center lg:text-left gap-4">
                                ...
                                <div className="flex flex-col gap-1 text-md text-center md:text-left items-center md:items-start">
