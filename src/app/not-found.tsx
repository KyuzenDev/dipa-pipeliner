    ...
    return (
        <div className="relative py-50 px-40 bg-white">
            ...
            <div className="flex flex-col h-max-[408px] items-center justify-center py-18 gap-12 rounded-4xl bg-white relative">
                <h1 className="absolute inset-0 flex items-center justify-center text-[408px] font-extrabold bg-gradient-to-b from-[#F5F8FC] to-[#FFFFFF] bg-clip-text text-grayscale-300 opacity-10 z-[1] drop-shadow-404">
                    404
                </h1>

                <SmileySadIcon size={30} />

                <h1 className="text-4xl font-bold text-grayscale-900 text-center">
                    <span className="text-primary-400">Uh-oh!</span> We can&apos;t seem <br /> to locate that page
                </h1>
                <p className="text-lg text-grayscale-500">
                    No worries — you can always start fresh from the homepage.
                </p>
                <Link
                    href="/"
                    className="inline-flex z-[1] items-center justify-center whitespace-nowrap ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-950 focus-visible:ring-offset-2 disabled:pointer-events-none cursor-pointer h-9 px-5 py-5 rounded-xl transition duration-300 ease-in-out drop-shadow-custom hover:drop-shadow-hover bg-linear-to-t border-1 border-[#FFFFFF33] bg-[#181B25] from-[#FFFFFF00] to-[#FFFFFF29] text-sm font-medium text-white"
                >
                    Return to Home
                </Link>
            </div>
